        ...
        <form className='flex w-full flex-wrap items-start justify-between'>
           ...
           <div>
            ...
            <div className='flex flex-col items-start w-2/5'>
                ...
                <textarea className='w-full h-44  py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400' name="" id="" cols='30' rows='10'></textarea>
                <button className='w-full py-3 hover:bg-emerald-600 px-5 rounded text-sm mt-4 bg-emerald-500 py-3 active:scale-95'>Create Task</button>
            </div>
